 ...
 * Ring Attention Skeleton — CUDA + MPI (CUDA-aware) + GPU attention
 *
 * Compile:
...
-np 2 ./ring_attention_cuda_aware_gpu_bench 262144 10 100
 */
#include<stdio.h>
#include<stdlib.h>
#include<math.h>
...
int main(int argc, char **argv){
    ...
    if(rank == 0){
        printf("CUDA-aware bench: warmup=%d iters=%d\n", warmup, iters);
